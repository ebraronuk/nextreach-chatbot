...
/**
 * LeadDetailPanel — shadcn Sheet (Radix Dialog) tabanli side drawer.
 * Focus trap, Escape, backdrop click ve animasyon Radix tarafindan saglanir.
 *
 * Icerik:
 *   - AI ozeti
 *   - Skor breakdown
  ...
  return (
    <Sheet open={lead !== null} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        {lead && (
          <>
            <SheetHeader className="p-5 border-b border-slate-200 space-y-1">
